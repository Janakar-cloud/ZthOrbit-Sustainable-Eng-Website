...
export default function Podcast({ onNavigate }: PodcastProps) {
  ...
  const [podcasts, setPodcasts] = useState<PodcastEpisode[]>([
    ...
    },
    {
      ...
      image: '/assets/images/AI & Sustainability.jpeg',
      duration: '52:15',
      category: 'technology',
    ...
    },
    {
      ...
      image: '/assets/images/Finance&Responsibilty.jpg',
      duration: '39:30',
      category: 'economy',
    ...
    },
    {
      ...
      image: '/assets/images/Governance-Risk-Management-and-Compliance.webp',
      duration: '43:40',
      category: 'leadership',
    ...
    },
    {
      ...
      image: '/assets/images/From Waste to Worth.png',
      duration: '42:30',
      category: 'sustainability',
