...
router.get("/", requireAuth(["superadmin", "admin", "editor", "viewer"]), async (req, res) => {
...
router.delete("/:id", requireAuth(["superadmin", "admin", "editor", "viewer"]), async (req, res) => {
...
router.delete("/", requireAuth(["superadmin", "admin", "editor", "viewer"]), async (req, res) => {
